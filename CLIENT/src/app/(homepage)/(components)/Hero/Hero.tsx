...
const Hero: FC = () => {
  return (
    <div className='relative left-1/2 -mt-14 flex h-[80vh] min-h-[500px] w-screen -translate-x-1/2 transform flex-col items-center justify-center'>
      <Image
        src={HeroImage}
        width={1920}
        height={1080}
        priority
        alt='Hero'
        className='absolute -z-10 h-full w-full transform object-cover object-center opacity-70 brightness-50 filter'
      />
